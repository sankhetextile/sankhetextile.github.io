...
// EMAIL MESSAGE
// *************
define('EMAIL_TO', 'prasad@sankhetextile.in');
define('EMAIL_TO_NAME', 'Prasad Sankhe');

define('EMAIL_TO_CC', 'prasad@sankhetextile.in');
define('EMAIL_TO_CC_NAME', 'Prasad Sankhe');

define('EMAIL_TO_BCC', 'info@kamlatech.in');
define('EMAIL_TO_BCC_NAME', 'Kamlatech');

define('EMAIL_FROM', 'info@sankhetextile.in');
define('EMAIL_FROM_NAME', 'Prasad Sankhe');
